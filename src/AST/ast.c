...
typedef enum {
    ...
    AST_LOGICAL_EQUALS_EXPR,
    AST_LOGICAL_NOT_EQUALS_EXPR,
    AST_LOGICAL_LESS_EXPR,
    AST_LOGICAL_GREATER_EXPR,
    AST_LOGICAL_LESS_EQUALS_EXPR,
    AST_LOGICAL_GREATER_EQUALS_EXPR,
    AST_CALL_EXPR,
    AST_ARG_LIST,
    AST_INT_LITERAL,
    AST_IDENTIFIER,
